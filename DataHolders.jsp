...
<scri pt src="//code.jquery.com/jquery-1.11.1.min.js"></script>
...
<div class="container ">
		...
		<div class="row">
            ...
            <a class="btn btn-danger mt-2" href="CSPHome.jsp">BACK</a>
        </div>
        
        <c:if   test="${param.success==1}">
		<div class="alert alert-success alert-dismissible fade show"
			role="alert">
			<strong>Success!</strong> OTP Has been Generated <a
				href="Home.jsp"></a>
			<button type="button" class="btn-close" data-bs-dismiss="alert"
				aria-label="Close">X</button>
		</div>
	</c:if> 
				<h2 ><span>DATAHOLDERS LIST</span></h2>
				<br>
					...
					<table id="myTable" class="table table-bordred table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td><a class="btn btn-primary btn-sm" type="submit"  href="GenerateOTP.jsp?Gemail=<%=rs.getString("email") %>">Generate OTP</a></td>
	...
	<script>
		...
		if(test=${param.success==1}){
			console.log("success");
			swal("Success!", "OTP has been Generated!", "success");
